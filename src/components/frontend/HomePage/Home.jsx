...
const Home = ({id}) => {
  return (
     <section id={id} className="bg-lightGray dark:bg-matteBlack transition-colors duration-500 text-black dark:text-white">
          ...
          <div className="right w-1/2 center-all">
            <div className="details  flex flex-col items-start">
              ...
              <Link to="projects" className="btn btn-call mt-5 font-bold">
                <p className='md:p-1 sm:p1'>See my works </p><ArrowRightCircle className='animate-ping md:block sm:hidden'/>
              </Link>
            </div>
          </div>
        </div>
