      ...
      >
        <div
          className={`
            ...
            ${isScrolled
              ? "h-16 max-w-[1200px] rounded-xl bg-white/40 dark:bg-gray-400/40 shadow-md backdrop-blur-md"
              : "h-24 max-w-full rounded-none"}
          `}
        >

        
          <div className="flex justify-start w-1/3">
            <Link to="/" className="dark:text-white hover:animate-pulse">
              <ArrowLeftFromLine />
            </Link>
          </div>
          ...
          <div className="flex justify-center w-1/3">
            <img
              className="md:max-w-[150px] drop-shadow-md sm:max-w-[90px]"
              src="/images/my-logo.png"
              alt="Logo"
            />
          </div>

          {/* RIGHT: Empty filler to keep the logo centered */}
